package com.greenhouse.auth.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema authSchema) {
        ...
        definition.setTargetNamespace("http://auth-service.dev/soap/auth");
    ...
    public XsdSchema authSchema() {
        return new SimpleXsdSchema(new ClassPathResource("ws/auth.xsd"));
    }
}
